...
def generateSunflowers(width, height):
    numSunflowers = random.randint(15,30) 
...
def modelGrassPatch():
    ...
    cmds.select(tallGrass_A,tallGrass_B,tallGrass_C,tallGrass_D,tallGrass_E,tallGrass_F,tallGrass_G,tallGrass_H,tallGrass_I)
    grassPatch = cmds.polyUnite(n='grassPatch')
    cmds.xform(grassPatch[0], centerPivots = True)
    cmds.delete(ch=True)
    cmds.scale(1.3,1.3,1.3)
